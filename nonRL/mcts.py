...
class MCTSNode:
    def __init__(self, state: BuckshotRoulette, parent=None, action=None):
        self.state: BuckshotRoulette = state  # The game state (BuckshotRoulette instance)
    ...
    def expand(self):
        ...
        unexplored_moves = [move for move in available_moves if move not in explored_moves]
...
class MCTS:
    def __init__(self, game: BuckshotRoulette, iterations=1000, exploration_weight=1.414):
        self.game: BuckshotRoulette = game  # The BuckshotRoulette instance
        self.iterations = iterations  # Number of MCTS iterations
        self.exploration_weight = exploration_weight  # Exploration vs Exploitation tradeoff
...
class MCTSEngine(AbstractEngine):
    def __init__(self, playing_as: Literal[0, 1], iterations: int = 1000, exploration_weight: float = 1.414):
    ...
    def choice(self, board: BuckshotRoulette):
        ...
        mcts = MCTS(game=board, iterations=self.iterations, exploration_weight=self.exploration_weight)
